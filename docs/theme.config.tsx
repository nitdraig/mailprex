...
const config: DocsThemeConfig = {
  head: (
    <>
      ...
      <meta name="twitter:site:domain" content="mailprex.excelso.xyz" />
      <meta name="twitter:url" content="https://mailprex.excelso.xyz" />
  ...
  footer: {
    text: (
      <span>
        ...
        <a href="https://mailprex.excelso.xyz" target="_blank">
          Mailprex
        </a>
        .
      </span>
