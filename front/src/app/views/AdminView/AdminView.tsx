  ...
  return (
    <div className="mx-auto flex w-full max-w-6xl flex-col gap-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="postal-dashboard-label mb-1">Platform control</p>
          <h2 className="postal-dashboard-title">Admin console</h2>
          ...
          <button
            ...
            className={`rounded-full px-4 py-2 text-sm font-medium transition-colors ${
              activeTab === tab.id
                ...
                : "bg-slate-200/70 text-slate-700 hover:bg-slate-200 dark:bg-white/10 dark:text-slate-200 dark:hover:bg-white/15"
            }`}
          >
            {tab.label}
          </button>
