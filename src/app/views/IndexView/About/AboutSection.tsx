...
const AboutSection = () => {
  return (
    <section className="py-16 bg-gradient-to-bl from-accent via-primary to-primary/70 h-full w-full">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between px-4">
        <div className="lg:w-1/2 mb-8 lg:mb-0">
          <img src="/grades.svg" alt="About Mailprex" className="" />
        </div>
        <div className="lg:w-1/2">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-accent">
            About Mailprex
          </h2>
