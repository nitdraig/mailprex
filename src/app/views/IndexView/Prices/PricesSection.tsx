...
const PricesSection = () => {
  return (
    <section className="flex lg:flex-row flex-col lg:justify-center items-center lg:p-8 p-4 font-sans bg-gradient-to-tr from-accent via-primary to-primary min-h-screen">
